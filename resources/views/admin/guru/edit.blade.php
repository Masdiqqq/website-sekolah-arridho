...
<head>
    ...
    <title>Edit Guru | MTs Arridho</title>
        ...
        >
            ...
            <div class="mt-6">
                ...
                <div class="mb-4">
                    @if ($guru->foto)
                        ...
                        >
                    @else
                        <div class="flex h-56 w-44 items-center justify-center rounded-2xl bg-emerald-100 text-4xl font-bold text-emerald-700">
                ...
                <p class="mt-2 text-xs text-slate-500">
                    Kosongkan jika foto tidak ingin diganti. Maksimal 4 MB.
                </p>
            ...
            <div class="mt-6">
                ...
                >
                    <option
                        value="aktif"
                        @selected(old('status', $guru->status) === 'aktif')
                    >
                        Aktif
                    </option>
                    ...
                    <option
                        value="nonaktif"
                        @selected(old('status', $guru->status) === 'nonaktif')
                    >
                        Nonaktif
                    </option>
                </select>
