...
<head>
    ...
    <title>Edit Prestasi | MTs Arridho</title>
...
<header class="border-b border-slate-200 bg-white">
    <div class="mx-auto flex max-w-4xl items-center justify-between gap-4 px-5 py-4">
        <div>
            <h1 class="font-bold text-emerald-900">Edit Prestasi</h1>
...
<main class="mx-auto max-w-4xl px-5 py-10">
    ...
    <form action="{{ route('admin.prestasi.update', $prestasi) }}" method="POST" enctype="multipart/form-data"
        ...
        <div class="mt-8 flex flex-col gap-3 sm:flex-row">
            <button type="submit" class="rounded-xl bg-emerald-700 px-6 py-3 font-semibold text-white hover:bg-emerald-800">Simpan Perubahan</button>
