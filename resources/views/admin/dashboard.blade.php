...
<body class="min-h-screen bg-slate-100 text-slate-800">
    ...
    <header class="sticky top-0 z-50 border-b border-slate-200 bg-white/95 backdrop-blur">
        <div class="mx-auto flex max-w-6xl items-center justify-between gap-4 px-5 py-4 lg:px-0">
    ...
    <main class="mx-auto max-w-6xl px-5 py-8 lg:px-0">
        ...
        {{-- Sambutan --}}
        <section class="overflow-hidden rounded-3xl bg-gradient-to-br from-emerald-950 via-emerald-900 to-emerald-700 p-8 text-white shadow-lg">
            ...
            <p class="mt-4 max-w-2xl leading-7 text-emerald-100/80">
                ...
                pengumuman, agenda, dan informasi website MTs Arridho.
            </p>
        ...
        <section class="mt-8 overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm">
            ...
            <div class="flex flex-col justify-between gap-4 border-b border-slate-200 px-7 py-6 sm:flex-row sm:items-center">
                        ...
                        @empty
                            <tr>
                                ...
                                >
                                    ...
                                    <p class="mt-2 text-sm text-slate-500">
                                        Berita, pengumuman, dan agenda akan tampil di sini.
                                    </p>
                                </td>
                            </tr>
                        @endforelse
            ...
            @if ($kontenTerbaru->hasPages())
                <div class="border-t border-slate-200 px-7 py-5">
                    {{ $kontenTerbaru->links() }}
                </div>
            @endif
